...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("LeaveRequestObjectPageObjectPage journey");

        opaTest("Navigate to LeaveRequestObjectPageObjectPage", function (Given, When, Then) {
            Given.iStartMyApp();
            ...
            Then.onTheEmployeesObjectPage.onTable({ property: "leaves" }).iCheckRows();
            When.onTheEmployeesObjectPage.onTable({ property: "leaves" }).iPressRow(0);

            Then.onTheLeaveRequestObjectPage.iSeeThisPage();
        });
