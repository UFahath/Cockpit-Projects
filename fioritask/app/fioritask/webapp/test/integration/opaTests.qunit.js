...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "fioritask/test/integration/FirstJourney",
    "fioritask/test/integration/EmployeesListJourney",
    "fioritask/test/integration/EmployeesObjectPageJourney",
    "fioritask/test/integration/LeaveRequestObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
