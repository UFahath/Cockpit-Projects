...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "stockmovement/test/integration/FirstJourney",
    "stockmovement/test/integration/StockMovementsListJourney",
    "stockmovement/test/integration/StockMovementsObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
